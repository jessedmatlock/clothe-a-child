...
<!--[if gt IE 8]><!--> <html class="no-js loading" <?php language_attributes(); ?> > <!--<![endif]-->
<head>
...
<header class="contain-to-grid sticky">
	...
	<nav class="top-bar" data-topbar>
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="Go to the Homepage" rel="home" id="logo" class="hide-for-medium-down"><img src="<?php echo get_template_directory_uri(); ?>/img/logo.png"  class="" id=""  alt="" /></a>
	    <?php
	        wp_nav_menu( array(
